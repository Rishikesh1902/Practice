...
public class Option 
{
	public static void main(String[] args) 
	{
		...
		do
		{
			...
			System.out.println("\n 8.   Program of Division without Use /");
			System.out.println("\n 9.  Program of Prime Number within Range");
			System.out.println("\n 10.  Program of Even Odd Check without Use of Arithmetic Operators");
			System.out.println("\n 11.  Program of Age Calculator (Age in Years Months and Days)");
			System.out.println("\n 12.  Program of Array's");
			System.out.println("\n 13.  EXIT");
					
			System.out.print("\n\n Please Enter the Number (1-13) : ");
			op = sc.nextInt();
			sc.nextLine();
			...
			switch(op)
			{
				...
				case 8 :	System.out.println("DIVISION WITHOUT USING /");
				...
				case 9 :	System.out.println("PRIME NUMBER WITHIN RANGE");
				...
				case 10 :	System.out.println("EVEN ODD CHECK WITHOUT USE OF ARITHMETIC OPERATOR");
				...
				case 11 :	System.out.println("AGE CALCULATOR - AGE IN YEARS, MONTHS AND DAYS");
				...
				case 12 :	System.out.println("ARRAY'S");
...
//=====================================================================================================================================	
	...
	/*
			PROGRAM 8 - DIVISION WITHOUT USING '/'
	*/
...
//=====================================================================================================================================	
	...
	/*
			PROGRAM 9 - PRIME NUMBER WITHIN RANGE
	*/
...
//=====================================================================================================================================	
	...
	/*
			PROGRAM 10 - EVEN ODD CHECK WITHOUT USE OF ARITHMETIC OPERATOR
	*/
